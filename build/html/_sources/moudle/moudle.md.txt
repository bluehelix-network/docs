...
## 密钥生成模块
密钥生成模块负责和BHSettle进行交互，为用户托管单元和运营账户托管单元生成对应公链相关的公私钥对，对跨链资产进行管理。
...
## 提案模块
Bluehelix采用链上治理的理念，Bluheliex采用提案(Proposal)方式来实现链上治理，bht持有者都可以通过发起提案、对提案抵押、对提案投票（需要委托bht）来参与Bluehlix的治理。
